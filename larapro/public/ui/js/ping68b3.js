...
window.fetchPing = /*#__PURE__*/function () {
  var _fetchPing = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            pingResponse = _context.sent; // const showGuestBlocksSelectors = ['.hp-signup-cta' , '.join-now-cta-section', '.lb-join-ref-prog'];
            ...
            if (pingResponse.flash_messages) Swal.fire(JSON.parse(pingResponse.flash_messages)); // On load stuffs
...
window.displayBrowserSpecificElements = function () {
  if (window.inside_chrome()) document.querySelectorAll(".d-chrome").forEach(function (el) {
    return el.classList.remove("d-none");
  });
  if (window.inside_firefox()) document.querySelectorAll(".d-firefox").forEach(function (el) {
    return el.classList.remove("d-none");
  });
  if (window.inside_safari()) document.querySelectorAll(".d-safari").forEach(function (el) {
    return el.classList.remove("d-none");
  });
  if (window.inside_edge()) document.querySelectorAll(".d-edge").forEach(function (el) {
    return el.classList.remove("d-none");
  });
};
...
/***/ 1:
/*!************************************!*\
  !*** multi ./resources/js/ping.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/dev/lbp8/packages/ui/resources/js/ping.js */"./resources/js/ping.js");
